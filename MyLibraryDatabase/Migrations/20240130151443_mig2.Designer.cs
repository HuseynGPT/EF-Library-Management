...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryDatabase.Entities.S_Card", b =>
                {
                    b.HasOne("LibraryDatabase.Entities.Book", "Book")
                        .WithMany("S_Cards")
                        .HasForeignKey("Id_Book")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryDatabase.Entities.Lib", "Lib")
                        .WithMany("S_Cards")
                        .HasForeignKey("Id_Lib")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryDatabase.Entities.Student", "Student")
                        .WithMany("S_Cards")
            ...
            modelBuilder.Entity("LibraryDatabase.Entities.T_Card", b =>
                {
                    ...
                    b.HasOne("LibraryDatabase.Entities.Teacher", "Teacher")
                        .WithMany("T_Cards")
